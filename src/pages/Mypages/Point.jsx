import {
  ...
  TitleHead,
  TitleWraper,
} from "../../components/CustomerService/Style";
    ...
    <>
      <MyPageLayout>
        ...
        <Div1>
          ...
          <img
            alt="컬리 배너"
            src="https://www.kurlypay.co.kr/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FIntroduceKurlyPayBanner.d8dd601a.png&w=1200&q=75"
          ></img>
          <ImgWarpper></ImgWarpper>
          <ActivityContainer>
            <BtnContainer>
...
const GuideIcon = styled.span`
  ...
  height: 20px;
  margin-top: 2px;
  background: url(https://res.kurly.com/mobile/ico/2010/ico_question_v2.svg)
    100% 50% / 20px 20px no-repeat;
  vertical-align: top;
`;
